...
function renderApiList() {
    const apiData = [
        ...
        { name: "Capcut Downloder", description: "Allows You To download video from Capcut Template using url", usage: "/api/capcut?url="}, { name: "Spotify Downloader", description: "Download Music Spotify Using Url Track to download", usage: "/api/spotifydl?url= },
        { name: "ChatGPT", description: "Ask Questions With ChatGPT 3.5", usage: "/api/chatgpt?input="}, { name: "Audio Youtube Downloader", description: "Allows you to download the audio from yt (credit some code by johnsteve and convert into routes api by Jonell Magallanes", usage: "/api/yt/audio?url="}, { name: "Rate My Photo", description: "Rating Your Photo With Analyzing AI", usage: "/api/ratep?photo=" }, { name: "Newgrounds Play Music Search", description: "Finding Song Fron Newgrounds Using Search Query", usage: "/api/ng?play=Stay inside me" }, { name: "Newgrounds Search Song Title List", description: "Search Query Title From Newgrounds Song", usage: "/api/newgrounds?query=" },
