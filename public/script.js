...
function renderApiList() {
    const apiData = [
        ...
        { name: "ChatGPT", description: "Ask Questions With ChatGPT 3.5", usage: "/api/chatgpt?input="}, { name: "Audio Youtube Downloader", description: "Allows you to download the audio from yt (credit some code by johnsteve and convert into routes api by Jonell Magallanes", usages: "/api/yt/audio?url="},
